...
date=os.system('date -d now')
os.system("cd / && sudo git add /etc && sudo git add /home && sudo git commit -m 'Dagelijkse back up: %s Reason: %s' && sudo git push -u origin master" %(date,reason))
