...
os.system("cd / && sudo git add /etc && sudo git add /home && sudo git add /root && sudo git add /usr/src && sudo git commit -m 'Dagelijkse back up datum: %s Reason: %s' && sudo git push -u origin master" %(date,reason))
