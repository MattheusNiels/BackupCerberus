...
# /build/linux-lts-vivid-whAhIw/linux-lts-vivid-3.19.0/kernel/bounds.c -m64
...
# -fverbose-asm --param allow-store-data-races=0 -fstack-protector
...
foo:
	...
	movq	%rsp, %rbp	#,
#APP
# 18 "/build/linux-lts-vivid-whAhIw/linux-lts-vivid-3.19.0/kernel/bounds.c" 1
	
->NR_PAGEFLAGS $25 __NR_PAGEFLAGS	#
# 0 "" 2
# 19 "/build/linux-lts-vivid-whAhIw/linux-lts-vivid-3.19.0/kernel/bounds.c" 1
	
->MAX_NR_ZONES $4 __MAX_NR_ZONES	#
# 0 "" 2
# 21 "/build/linux-lts-vivid-whAhIw/linux-lts-vivid-3.19.0/kernel/bounds.c" 1
	
->NR_CPUS_BITS $8 ilog2(CONFIG_NR_CPUS)	#
# 0 "" 2
# 23 "/build/linux-lts-vivid-whAhIw/linux-lts-vivid-3.19.0/kernel/bounds.c" 1
